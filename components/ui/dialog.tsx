...
// NOTE: Use React.ComponentRef & React.ComponentPropsWithoutRef
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      // If you want the overlay above a z-50 header, change to z-[110]
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // VisualStage will override sizing/z; this is fine for default dialogs
