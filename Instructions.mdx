...
<Callout title="Prompt Model"> The structure that sets personality, constraints, and how tools should be chosen. </Callout>
...
<Callout title="Data Object Model"> The flexible JSON returned by your APIs that the agent uses for grounding. </Callout>
